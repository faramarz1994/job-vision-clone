    ...
    <div className="bg-grayFA min-h-screen flex flex-col justify-between items-center py-10">
      ...
      <div className="flex flex-col items-center rounded-md shadow-lg bg-white justify-between  pb-6">
        ...
        <div className="w-full bg-blueF2 text-white px-10 py-6 text-center rounded-t-md" >
          ...
          <p className="text-sm">برای ادامه، شماره موبایل یا آدرس ایمیل خود را وارد کنید.</p>
          <p className="text-sm">با ورود و یا ثبت‌نام در جاب ویژن، قوانین و مقررات جاب ویژن را خواهید پذیرفت.
</p>
        </div>
        <div
        ...
        <div className="w-4/5 h-40 flex items-center justify-center mt-10 mb-4">
        {
          layouts[step]
        }
        </div>
        <div className="flex items-center w-3/4 justify-between">
          <Link to="" className="flex w-full mx-1 justify-center items-center ltr p-4 bg-white rounded-xl shadow-md">
            <img src={googleLogo} />
            <p className="font-black text-xs ml-2">ورود و ثبت نام با گوگل</p>
          </Link>
          <Link to="" className="flex items-center justify-center w-full mx-1 ltr p-4 bg-white rounded-xl shadow-md">
