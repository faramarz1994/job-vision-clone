  ...
  return (
    <div className='fixed flex items-end bottom-0 left-0 p-5 z-50 justify-center'>
        <div className='bg-blueF2 flex flex-col justify-between text-gray-100 text-xs h-32 rounded-xl leading-normal w-72'>
            <p className='p-3 '>در صورتی که می‌خواهید از آخرین فرصت‌های شغلی مرتبط، باخبر شوید روی اجازه می‌دهم کلیک کنید.</p>
            <div className='w-full flex justify-between'>
                <button className='w-1/2 ml-1 h-10 flex items-center justify-center text-white bg-purpulFF rounded-md'>
                        اجازه میدهم
                </button>
                <button className='w-1/2 mr-1 h-10 flex items-center justify-center text-white bg-purpulFF rounded-md'>
                بعدا انجام میدهم
</button>
            </div>
        </div>
